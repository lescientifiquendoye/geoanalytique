...
public class ViewPort {
    ...
    //La fonction getScale permet de calculer le rapport entre la taille de la fenetre
    //et la taille de la zone d'affichage.
    //Elle est utile pour redimensionner les objets graphiques en fonction de la taille de la fenetre.
    public double getScale() {
        double scaleX = largeur / (xmax - xmin);
        double scaleY = hauteur / (ymax - ymin);
    ...
    public Point convert(int x, int y) {
    	...
    	return new Point((int)xm,(int)ym,null);
    }
}
